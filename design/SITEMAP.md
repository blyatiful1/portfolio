...
7. operator — skill: feature-sections + forms — variant: split 7/5 with stat card (Framed Data) — density: H2 + ≤80 words + 3-line what-I-bring list + 223/225 stat card w/ verify command + inline contact form (name/email/message, server action Phase 7) + GitHub ghost CTA — width: contained — rhythm: release before the ask, double air — job: the human, the ask [correction 2026-09-01: form restored from BRIEF backend needs — wireframe had under-specified it]
