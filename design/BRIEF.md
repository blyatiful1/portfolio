...
- Curated repo list: ultraweb, hardmode, gtheme, NightCityMP, ultraweb-site; excluded: profile-README repo, forks (CyberpunkMP, RED4ext.SDK) — creative draft of the user's curation, needs confirmation at CP1.
